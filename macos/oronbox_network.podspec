...
Native network package used by OronBox for Xiaomi Vela OS and MiWear devices.
                       DESC
  s.homepage         = 'https://github.com/zxor-org/OronBox-Package-Network'
  s.license          = { :type => 'AGPL-3.0', :file => '../LICENSE' }
  s.author           = { 'OronBox contributors' => 'https://github.com/zxor-org' }
  s.source           = { :path => '.' }
  ...
  s.prepare_command = <<-CMD
    ...
    cd - >/dev/null
    tar -xzf "/tmp/${ASSET}" -C Frameworks --strip-components=1 lib/liboronbox_network.dylib
  CMD
end
