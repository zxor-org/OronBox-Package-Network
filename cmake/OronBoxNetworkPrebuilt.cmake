set(ORONBOX_NETWORK_VERSION "0.1.3")
...
function(oronbox_network_fetch ASSET OUTPUT_DIR)
  ...
  if(NOT EXISTS "${ARCHIVE}")
    file(DOWNLOAD
      "${ORONBOX_NETWORK_RELEASE_BASE}/${ASSET}"
      "${ARCHIVE}"
  ...
  if(NOT EXISTS "${CHECKSUM_FILE}")
    file(DOWNLOAD
      "${ORONBOX_NETWORK_RELEASE_BASE}/${ASSET}.sha256"
      "${CHECKSUM_FILE}"
